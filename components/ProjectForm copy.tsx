          ...
          <div>
            ...
            {!imagePreview ? (
              <div
                ...
                className="border-2 border-dashed border-gray-600/50 rounded-lg p-6 text-center cursor-pointer hover:border-gray-500/50 transition-colors bg-gray-800/30"
              >
